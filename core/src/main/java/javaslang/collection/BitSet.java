...
/**
 * Created by MarkPerry on 5 Jul 16.
 */
...
//            return empty().addAll(Array.array(values));
//        }
//
...
//        }
//
//        public BitSet<T> ofAll(java.util.stream.Stream<T> javaStream) {
//            Objects.requireNonNull(javaStream, "javaStream is null");
//            return empty().addAll(() -> javaStream.iterator());
//        }
//
